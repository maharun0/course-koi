  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-medium text-xs truncate flex-1">{c.courseCode}</span>
      </button>
      <button
        onClick={(e) => {
          e.stopPropagation();
        ...
        <div className="glass rounded-xl p-3 flex-1 flex flex-col overflow-hidden relative gap-2 w-64">
          ...
          <div>
            ...
            >
              ...
              <span className="font-bold text-xs text-gray-100">All Courses</span>
            </button>
          </div>
          ...
          {/* Footer Actions */}
          <div className="pt-2 border-t border-white/10 space-y-0.5 shrink-0">
            <button
              onClick={() => {
                setView('starred');
                setActiveCourse(null);
            ...
            <button
              ...
              className="w-full text-left p-1.5 rounded flex items-center gap-2 text-xs font-medium text-gray-500 hover:text-red-300 hover:bg-red-500/10 transition-colors cursor-pointer"
